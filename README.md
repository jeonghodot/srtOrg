```cmd
python quickstart.py --user 1582372286 --psw 0 --dpt 수서 --arr 동대구 --dt 20221008 --tm 12 --num 10 --reserve True --iter 5
```

```cmd
python quickstart.py --user 1582372286 --psw  --dpt 수서 --arr 동대구 --dt 20221008 --tm 12 --num 10 --reserve True
```
